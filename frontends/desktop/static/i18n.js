(() => {
  ...
  en: {
    ...
    'sys.otaDone': 'Updated, restart the app to take effect',
    ...
    'sys.otaRestartMsg': 'Updated from v{previous} to v{current}. Restart to apply.',
