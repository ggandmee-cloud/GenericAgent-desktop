(() => {
  ...
  zh: {
    ...
    'chat.recent': '最近会话', 'preset.groupModes': '模式', 'preset.groupTasks': '任务',
    'page.back': '返回', 'collab.connected': 'Conductor 已连接',
    ...
    'set.appearance': '外观', 'set.plainUi': '素色', 'set.fontSize': '聊天字号', 'set.lang': '语言', 'set.model': '模型', 'set.addModel': '添加模型', 'set.features': '功能', 'set.importMykey': '导入模型配置', 'set.exportMykey': '导出模型配置', 'set.importMemory': '导入记忆与会话记录', 'set.moveGaRuntime': '复制并切换 GA 工作目录', 'set.gaSource': '接入外部 GenericAgent 源码', 'set.gaSourceClear': '改用内置版本', 'set.gaSourceCurrent': '当前接入',
    ...
    'set.checkUpdateTip': '检查运行时与桌面壳更新（plan.khrey.com）',
    'set.gaToken': 'GA Token',
    'set.gaTokenTip': '打开 plan.khrey.com，一键导入模型与 API Key',
    'set.pcLink': '手机互联',
    'set.pcLinkTip': '出示二维码，用 GAndroid 扫码连接本机',
    'modal.pcLink': '手机互联',
    'modal.pcLinkHint': '打开手机 GA → 设置 → PC 互联 → 扫码',
    'modal.pcLinkOpenPage': '在浏览器打开配对页',
    'modal.pcLinkRePair': '刷新配对码',
    'modal.pcLinkPhones': '已配对的手机',
    'modal.pcLinkNoPhones': '尚无手机配对，扫上方二维码即可添加',
    'modal.pcLinkPhone': '手机 {n}',
    'modal.pcLinkPairedAt': '配对于 {t}',
    'modal.pcLinkForget': '移除',
    'sys.pcLinkCodeExpired': '配对码已过期，正在换新',
    'sys.pcLinkPhoneRemoved': '已移除该手机',
    'sys.gaTokenOpen': '已打开 TokenPlan，导入完成后配置会自动刷新',
    'sys.tokenplanImported': 'TokenPlan 模型已导入',
    'err.gaToken': '无法打开 TokenPlan 导入',
    'sys.pcLinkConnected': '手机已连接',
    'sys.pcLinkWaiting': '等待手机扫码',
    'sys.pcLinkReconnecting': '正在重连',
    'err.pcLink': '无法启动手机互联',
    ...
    'conv.emptySearch': '没有匹配的会话',
    'conv.groupPinned': '置顶', 'conv.groupToday': '今天', 'conv.groupYesterday': '昨天',
    'conv.groupWeek': '近 7 天', 'conv.groupEarlier': '更早',
    'conv.runningFor': '运行中 · {t}', 'conv.doneMeta': '已完成 · 用时 {t}',
    'conv.doneToast': '「{title}」已完成，点击查看',
    'time.justNow': '刚刚', 'time.minAgo': '{n} 分钟前', 'time.daysAgo': '{n} 天前', 'time.yesterday': '昨天',
    'confirm.convDelete': '删除会话「{title}」？消息记录将一并删除，不可恢复。',
    ...
    'sys.otaChecking': '正在检查更新…',
    'sys.otaLatest': '已是最新版本',
    'sys.otaFound': '发现新版本，再点一次开始更新',
    'sys.otaApplying': '正在下载并更新…',
    'sys.otaDone': '更新完成，正在重启运行时…',
    'sys.otaUpdateTitle': '发现新版本',
    'sys.otaUpdateMsg': '当前 v{current}，最新 v{latest}。请更新后继续使用。',
    'sys.otaUpdateNow': '立即更新',
    'sys.otaRestartMsg': '已从 v{previous} 更新到 v{current}。将重启运行时以加载新代码。',
    'sys.otaRestartNow': '立即重启',
    'sys.otaRestarting': '正在重启 bridge / hub…',
    'sys.otaShellFound': '发现桌面壳新版本，再点一次开始更新（将退出并重启应用）',
    'sys.otaShellUpdateMsg': '桌面壳当前 v{current}，最新 v{latest}。更新将退出应用并由助手完成替换。',
    'sys.otaShellApplying': '正在下载桌面壳整包…',
    'sys.otaShellExiting': '已准备好换壳，正在退出应用…',
    'sys.otaShellQuitHint': '请完全退出 GenericAgent，换壳助手会自动拉起新版本',
    'sys.otaShellBlocked': '当前安装位置无法自动换壳（请拖到「应用程序」后手动重装）',
    'sys.otaShellUnknown': '无法判定壳版本，请手动下载安装包',
    'sys.otaShellManual': '请手动下载安装包更新桌面壳',
    'err.ota': '更新失败',
  ...
  en: {
    ...
    'chat.recent': 'Recent', 'preset.groupModes': 'Modes', 'preset.groupTasks': 'Tasks',
    'page.back': 'Back', 'collab.connected': 'Conductor connected',
    ...
    'set.checkUpdateTip': 'Check runtime and desktop-shell updates (plan.khrey.com)',
    'set.gaToken': 'GA Token',
    'set.gaTokenTip': 'Open plan.khrey.com to import models and API keys',
    'set.pcLink': 'Link phone',
    'set.pcLinkTip': 'Show a QR code for GAndroid to scan',
    'modal.pcLink': 'Link phone',
    'modal.pcLinkHint': 'On phone: Settings → PC Link → Scan QR',
    'modal.pcLinkOpenPage': 'Open pairing page in browser',
    'modal.pcLinkRePair': 'New code',
    'modal.pcLinkPhones': 'Paired phones',
    'modal.pcLinkNoPhones': 'No phones yet — scan the QR above to add one',
    'modal.pcLinkPhone': 'Phone {n}',
    'modal.pcLinkPairedAt': 'Paired {t}',
    'modal.pcLinkForget': 'Remove',
    'sys.pcLinkCodeExpired': 'Code expired, issuing a new one',
    'sys.pcLinkPhoneRemoved': 'Phone removed',
    'sys.gaTokenOpen': 'TokenPlan opened; config refreshes after import',
    'sys.tokenplanImported': 'TokenPlan models imported',
    'err.gaToken': 'Could not open TokenPlan import',
    'sys.pcLinkConnected': 'Phone connected',
    'sys.pcLinkWaiting': 'Waiting for phone to scan',
    'sys.pcLinkReconnecting': 'Reconnecting',
    'err.pcLink': 'Could not start phone link',
    ...
    'conv.emptySearch': 'No matching conversations',
    'conv.groupPinned': 'Pinned', 'conv.groupToday': 'Today', 'conv.groupYesterday': 'Yesterday',
    'conv.groupWeek': 'Last 7 days', 'conv.groupEarlier': 'Earlier',
    'conv.runningFor': 'Running · {t}', 'conv.doneMeta': 'Done · {t}',
    'conv.doneToast': '“{title}” finished — click to view',
    'time.justNow': 'just now', 'time.minAgo': '{n}m ago', 'time.daysAgo': '{n}d ago', 'time.yesterday': 'yesterday',
    'confirm.convDelete': 'Delete “{title}”? Its messages will be removed permanently.',
    ...
    'sys.otaChecking': 'Checking for updates…',
    'sys.otaLatest': 'Already up to date',
    'sys.otaFound': 'Update found, click again to install',
    'sys.otaApplying': 'Downloading and updating…',
    'sys.otaDone': 'Updated — restarting runtime…',
    'sys.otaUpdateTitle': 'Update available',
    'sys.otaUpdateMsg': 'Current v{current}, latest v{latest}. Please update to continue.',
    'sys.otaUpdateNow': 'Update now',
    'sys.otaRestartMsg': 'Updated from v{previous} to v{current}. Restarting runtime to load new code.',
    'sys.otaRestartNow': 'Restart now',
    'sys.otaRestarting': 'Restarting bridge / hub…',
    'sys.otaShellFound': 'Desktop shell update found — click again (app will quit and relaunch)',
    'sys.otaShellUpdateMsg': 'Shell v{current} → v{latest}. The app will quit while a helper swaps the binary.',
    'sys.otaShellApplying': 'Downloading desktop package…',
    'sys.otaShellExiting': 'Shell package ready — quitting so the helper can swap…',
    'sys.otaShellQuitHint': 'Fully quit GenericAgent; the helper will relaunch the new build',
    'sys.otaShellBlocked': 'This install path cannot auto-update the shell (move to Applications, then reinstall)',
    'sys.otaShellUnknown': 'Cannot determine shell version — download the installer manually',
    'sys.otaShellManual': 'Please download the desktop installer to update the shell',
